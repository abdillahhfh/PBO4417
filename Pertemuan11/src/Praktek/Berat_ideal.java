...
public class Berat_ideal extends Frame implements ActionListener{
    ...
    Berat_ideal(){
        ...
        btnMainMenu.setBounds(170, 290, 70, 35);
           
        //LABEL FOR RESULT
        showNim = new Label();
        showNim.setBounds(70, 350, 200, 20);
        
        showName = new Label();
        showName.setBounds(70, 370, 200, 20);
        
        showText = new Label();
        showText.setBounds(70, 390, 200, 20);
        
        add(lNim); add(lNama); add(lBerat); add(lTinggi);
        add(tNim); add(tNama); add(tBerat); add(tTinggi);
        add(showNim); add(showName); add(showText);
        add(btnHitung); add(btnMainMenu);
